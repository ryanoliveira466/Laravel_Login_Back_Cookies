...
class PostController extends Controller
{
    ...
    public function publicIndexQuery(Request $request)
    {
        ...
        try {
            ...
            $posts = Post::with(['user:id,name,slug,photo,email'])
                ->select('id', 'user_id', 'name', 'description', 'javascript', 'css', 'html', 'slug', 'photo', 'tags', 'likes')
    ...
    public function userProjects(Request $request)
    {
        ...
        try {
            ...
            $posts = Post::select('id', 'name', 'description', 'javascript', 'css', 'html', 'slug', 'photo', 'tags', 'likes')->where('user_id', $user->id)->get();
